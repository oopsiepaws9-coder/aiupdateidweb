...
export default function Footer(){
  return <footer><div className="container footerGrid">
    ...
    <div><h4>Konten</h4><Link href="/kategori/berita-ai">Berita AI</Link><Link href="/tools">Tools AI</Link><Link href="/kategori/tutorial">Tutorial</Link><Link href="/kategori/review">Review</Link></div>
